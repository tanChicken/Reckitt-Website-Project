...
export const productItems: ProductItem[] = [
  ...
  },
  {
    ...
    description:
      "A pain and fever category for users who want everyday relief options.",
    needId: "pain-fever",
    imageLabel: "NF",
  ...
  },
  {
    ...
    description:
      "A cough-care category for mucus and chest congestion support.",
    needId: "cough-mucus",
    imageLabel: "MX",
  ...
  },
  {
    ...
    description:
      "A digestive-care category for reflux, acidity, and indigestion needs.",
    needId: "heartburn",
    imageLabel: "GV",
  ...
  },
  {
    ...
    description:
      "A home-care category for dishes, laundry, toilet, and surface cleaning.",
